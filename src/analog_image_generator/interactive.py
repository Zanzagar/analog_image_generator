...
_FLUVIAL_SLIDER_LIBRARY: "OrderedDict[str, SliderGroup]" = OrderedDict(
    [
                ...
                "sliders": OrderedDict(
                    [
                        ...
                        (
                            "levee_iterations",
                            {
                                "key": "levee_iterations",
                                "label": "Levee iterations",
                                "min": 1,
                                "max": 12,
                                "step": 1,
                                "default": 5,
                                "units": "iter",
                                "source": "AGENTS.md levee rim controls",
                                "citation_ids": ["research-meander-levee"],
                                "dtype": "int",
                                "description": "Dilate/blur iterations for levee rims.",
                            },
                        ),
                        (
                            "scroll_lambda_px",
                            {
                                "key": "scroll_lambda_px",
                                "label": "Scroll/bar spacing (px)",
                                "min": 12,
                                "max": 64,
                                "step": 2,
                                "default": 28,
                                "units": "px",
                                "source": "Scroll-bar spacing mandates",
                                "citation_ids": ["research-meander-scroll"],
                                "dtype": "int",
                                "description": "Wavelength for scroll-bar banding along the belt.",
                            },
                        ),
                        (
                            "oxbow_probability",
                            {
                                "key": "oxbow_probability",
                                "label": "Oxbow probability",
                                "min": 0.0,
                                "max": 0.6,
                                "step": 0.02,
                                "default": 0.25,
                                "units": "prob",
                                "source": "Cutoff likelihood (PRD/AGENTS)",
                                "citation_ids": ["research-meander-oxbow"],
                                "dtype": "float",
                                "description": "Probability of neck cutoff scars along the belt.",
                            },
                        ),
                    ]
                ),
                ...
                "sliders": OrderedDict(
                    [
                        ...
                        (
                            ...
                            {
                                "key": "chute_frequency",
                                "label": "Chute frequency",
                                "min": 0.0,
                                "max": 1.0,
                                "step": 0.05,
                                "default": 0.35,
                                "units": "prob",
                                "source": "Braided chute propensity",
                                "citation_ids": ["research-braided-chute"],
                                "dtype": "float",
                                "description": "Frequency for chute cross-cuts through bars/threads.",
                            },
                        ),
                    ]
                ),
                ...
                "sliders": OrderedDict(
                    [
                        ...
                        (
                            "levee_height_scale",
                            {
                                "key": "levee_height_scale",
                                "label": "Levee height scale",
                                "min": 0.2,
                                "max": 1.2,
                                "step": 0.05,
                                "default": 0.65,
                                "units": "scale",
                                "source": "Makaske 2001 marsh-dominated belts",
                                "citation_ids": ["research-anasto-levee-height"],
                                "dtype": "float",
                                "description": "Scale factor for levee rim height.",
                            },
                        ),
                        (
                            "fan_length_px",
                            {
                                ...
                                "default": 35,
                                "units": "px",
                                "source": "Breach fan geometry",
                                "citation_ids": ["research-anasto-fan"],
                                "dtype": "int",
                                "description": "Length scale for fans seeded at levee breaches.",
                            },
                        ),
                    ]
                ),
                ...
                "sliders": OrderedDict(
                    [
                        ...
                        (
                            ...
                            {
                                "key": "package_thickness_px",
                                "label": "Package thickness (px)",
                                "min": 24,
                                "max": 96,
                                "step": 4,
                                "default": 42,
                                "units": "px",
                                "source": "Stacked package thickness",
                                "citation_ids": ["agents-stacked"],
                                "dtype": "int",
                                "description": "Thickness assigned to each stacked package.",
                            },
                        ),
                    ]
                ),
        ...
        (
            "facies_overlays",
            {
                "label": "Facies / overlay controls",
                "sliders": OrderedDict(
                    [
                        (
                            "cross_bed_strength",
                            {
                                "key": "cross_bed_strength",
                                "label": "Cross-bedding strength",
                                "min": 0.0,
                                "max": 0.25,
                                "step": 0.01,
                                "default": 0.1,
                                "units": "scale",
                                "source": "Sedimentary overlay tuning",
                                "citation_ids": ["research-cross-bed"],
                                "dtype": "float",
                                "description": "Scale for cross-bedding overlay contribution.",
                            },
                        ),
                        (
                            "ripple_strength",
                            {
                                ...
                                "units": "scale",
                                "source": "Sedimentary overlay tuning",
                                "citation_ids": ["research-ripple"],
                                "dtype": "float",
                                "description": "Scale for ripple overlay contribution.",
                            },
                        ),
                        (
                            "ripple_wavelength_px",
                            {
                                "key": "ripple_wavelength_px",
                                "label": "Ripple wavelength (px)",
                                "min": 6.0,
                                "max": 20.0,
                                "step": 0.5,
                                "default": 10.0,
                                "units": "px",
                                "source": "Ripple wavelength bounds",
                                "citation_ids": ["research-ripple"],
                                "dtype": "float",
                                "description": "Wavelength for ripple pattern; set to 0 to revert to random.",
                            },
                        ),
                        (
                            "fining_strength",
                            {
                                "key": "fining_strength",
                                "label": "Fining-upward strength",
                                "min": 0.0,
                                "max": 2.0,
                                "step": 0.1,
                                "default": 1.0,
                                "units": "scale",
                                "source": "Fining overlay tuning",
                                "citation_ids": ["research-fining"],
                                "dtype": "float",
                                "description": "Scale for fining-upward overlay.",
                            },
                        ),
                        (
                            "mudstone_strength",
                            {
                                "key": "mudstone_strength",
                                "label": "Mudstone strength",
                                "min": 0.0,
                                "max": 2.0,
                                "step": 0.1,
                                "default": 1.0,
                                "units": "scale",
                                "source": "Mudstone overlay tuning",
                                "citation_ids": ["research-mudstone"],
                                "dtype": "float",
                                "description": "Scale for overbank mudstone contribution.",
                            },
                        ),
                        (
                            "lateral_accretion_strength",
                            {
                                "key": "lateral_accretion_strength",
                                "label": "Lateral accretion strength",
                                "min": 0.0,
                                "max": 2.0,
                                "step": 0.1,
                                "default": 1.0,
                                "units": "scale",
                                "source": "Accretion overlay tuning",
                                "citation_ids": ["research-lateral-accretion"],
                                "dtype": "float",
                                "description": "Scale for lateral accretion surface highlights.",
                            },
                        ),
                    ]
                ),
